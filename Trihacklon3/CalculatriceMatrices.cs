...
namespace Trihacklon3
{
    public class CalculatriceMatrices
    {
        ...
        /// <summary>
        /// Détermine si un chemin existe dans la matrice m à partir de la case r, c
        /// vers une case contenant un -1.
        /// 
        /// Les cases vides sont représentées par des 0, les murs par des -2,
        /// les fins par des -1.
        /// 
        /// Le chemin peut aller à gauche, en haut, à droite ou en bas (pas de diagonales)
        /// </summary>
        /// <example>
        /// La matrice suivante est un labyrinthe. Il existe un chemin à partir de la case r = 0, c = 0
        /// vers un -1 :
        /// 
        ///  0  0 -2  0  0 -1
        /// -2  0 -2  0 -2 -2
        ...
        /// -2  0 -2  0  0  0
        /// </example>
        /// <param name="m">Une matrice d'entier</param>
        /// <param name="r">La coordonnée rangée du point de départ</param>
        /// <param name="c">La coordonnée colonne du point de départ</param>
        /// <returns>Vrai s'il existe un chemin dans m à partir de la case r, c
        /// vers une case contenant un -1.</returns>
        public static bool Labyrinthe(int[,] m, int r, int c)
        {
            return false;
        }

        /// <summary>
        /// Trouve un chemin, s'il en existe un, dans la matrice m à partir de la case r, c
        /// vers une case contenant un -1.
        /// 
        /// Pour décrire le chemin, une série de cailloux sont placés dans la
        /// matrice. Les cailloux seront représentés par des nombres positifs, commençant
        /// par depart.
        /// 
        /// Les cases vides sont représentées par des 0, les murs par des -2,
        /// les fins par des -1 et le chemin parcouru par des nombres croissants.
        /// 
        /// Le chemin peut aller à gauche, en haut, à droite ou en bas (pas de diagonales)
        /// 
        /// Le chemin trouvé n'est pas nécessairement le plus court, mais on ne revient jamais sur nos pas.
        /// </summary>
        /// <example>
        /// La matrice suivante est un labyrinthe. Il existe un chemin à partir de la case r = 0, c = 0
        /// vers un -1 :
        /// 
        ///  0  0 -2  0  0 -1       1  2 -2 10 11 -1
        /// -2  0 -2  0 -2 -2      -2  3 -2  9 -2 -2
        ///  0  0 -2  0  0  0  ==>  0  4 -2  8  0  0
        /// -2  0  0  0 -2  0      -2  5  6  7 -2  0
        /// -2  0 -2  0  0  0      -2  0 -2  0  0  0
        /// </example>
        /// <param name="m">Une matrice d'entier</param>
        /// <param name="r">La coordonnée rangée du point de départ</param>
        /// <param name="c">La coordonnée colonne du point de départ</param>
        /// <param name="depart">Le premier nombre à écrire dans le labyrinthe pour représenter le chemin</param>
        /// <returns>Vrai s'il existe un chemin dans m à partir de la case r, c
        /// vers une case contenant un -1.</returns>
        public static bool Labyrinthe(int[,] m, int r, int c, int depart)
        {
            return false;
        }
    }
